                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'td',
                                null,
                                React.createElement('input', { type: 'text', id: 'name', value: this.state.value, onChange: this.handleChange })
                            )
                        ),
                        React.createElement(
                            'tr',
...
ReactDOM.render(React.createElement(NameForm, null), document.getElementById('app'));
